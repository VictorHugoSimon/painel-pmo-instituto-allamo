ALTER TABLE issues ADD COLUMN item_type TEXT DEFAULT 'TASK';
...
ALTER TABLE issues ADD COLUMN rank REAL DEFAULT 0;
ALTER TABLE issues ADD COLUMN reporter TEXT;
ALTER TABLE issues ADD COLUMN blocked INTEGER DEFAULT 0;
ALTER TABLE issues ADD COLUMN blocked_reason TEXT;
ALTER TABLE issues ADD COLUMN source TEXT DEFAULT 'allamo';
